...
private oBrwLotes, oBrwNotas, oBrwHist, oCodigo, oLote, oSaldo, oDataCo, oDiasDi, oPesoCo, oPesMat, oCMSPV,;
         oRealizado, oPrevisto, oDifVlr, oDifPerc, oMgKPrev, oMgKReal, oGmdEsp,;
...
private lCanChange := .t.
    ...
    oCmbPeriod := TComboBox():New( 30, 80, {|u| Iif(PCount()>0, cPeriodo := u, cPeriodo)}, {"Noite", "Madrugada", "Manhã"}, 60, /*nHeight*/, oWndNotas, /*uParam8*/, /*bChange*/, /*bValid*/, /*nClrText*/, /*nClrBack*/, .t., /*oFont*/, /*uParam15*/, /*uParam16*/, /*bWhen*/, /*uParam18*/, /*uParam19*/, /*uParam20*/, /*uParam21*/, /*cReadVar*/, "Período", 1, /*oLabelFont*/, /*nLabelColor*/ )
