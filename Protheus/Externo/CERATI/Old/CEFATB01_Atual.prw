...
/* 	oView:SetFieldAction("Z6G_LOTEVIF",bBloco)	
	oView:SetFieldAction("CBC_NTPAD"  ,bBloco)	 */
	...
	/* oView:SetViewProperty('VIEW_GridM', "ENABLEDGRIDDETAIL", { 20 } ) */
...
Static Function ViewActv()
    oView    := FWViewActive()
    oView:Refresh('VIEW_GridM')
    oView:GetViewObj("VIEW_GridM")[3]:getFWEditCtrl("Z6G_LOTEVIF"):oCtrl:SetFocus()
Return
Static function MinhaAcao()
	Local oView := FWViewActive()
	oView:GetviewObject("VIEW_GridM")[3]:GetViewStruct("VIEW_GridM"):getFWEditCtrl("Z6G_LOTEVIF"):oCtrl:SetFocus()
return
