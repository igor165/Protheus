...
STATIC FUNCTION GeraX1(cPerg)
    ...
    AADD(aRegs,{cPerg,"05","Fornecedor de   ?",Space(20),Space(20),"mv_ch5", TamSX3("ZCC_CODFOR")[3], TamSX3("ZCC_CODFOR")[1], TamSX3("ZCC_CODFOR")[2],0,"G","","mv_par05","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
	AADD(aRegs,{cPerg,"06","Fornecedor ate  ?",Space(20),Space(20),"mv_ch6", TamSX3("ZCC_CODFOR")[3], TamSX3("ZCC_CODFOR")[1], TamSX3("ZCC_CODFOR")[2],0,"G","","mv_par06","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
...
STATIC FUNCTION fLoadSQL(cTipo, _cAlias)
    ...
    IF cTipo == "Geral"
        ...
        _cQry   += "            AND ZBC.ZBC_CODFOR BETWEEN '"+ mv_par05 + "' AND '" + mv_par06 +"'"+ CRLF
        _cQry   += "            AND ZCC.ZCC_CODIGO BETWEEN '" + mv_par03 + "' AND '" + mv_par04 + "'"+ CRLF
        _cQry   += "            AND ZBC_PRODUT LIKE 'BOV%'"+ CRLF
