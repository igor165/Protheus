...
WSRESTFUL WSPesagem DESCRIPTION "Metodo para receber placa da portaria e fazer reserva na rotina de Pesagens." FORMAT APPLICATION_JSON
    ...
    WSMETHOD POST RESERVAPLACA DESCRIPTION "Inclusao de reserva de placa para futura pesagem." ;
                WSSYNTAX "/WSPesagem/" //PATH "/WSPesagem/{placa}"
    // WSMETHOD GET DESCRIPTION "Exemplo de retorno de entidade(s)" WSSYNTAX "/WSPesagem || /WSPesagem/{placa}"
    WSMETHOD PUT RESERVAPLACA DESCRIPTION "Inclusao de reserva de placa para futura pesagem." ;
                WSSYNTAX "/WSPesagem/{cAgendamentoId}"/* ;
                PATH "/WSPesagem/{cAgendamentoId}" */
    WSMETHOD DELETE RESERVAPLACA DESCRIPTION "Inclusao de reserva de placa para futura pesagem.";
                WSSYNTAX "/WSPesagem/{cAgendamentoId}"/* ;
                PATH "/{cAgendamentoId}" */
...
Else
    ...
    Else
        ...
        Else
            ...
            _cCPF_CNPJ := ""
            If ZPB->ZPB_CLIFOR == "C" // Fornecedor
...
Retorno json
{
"retorno": "Nao foi localizado nenhuma informacao."
}
