...
if (cAlias)->(!Eof())
	...
	For nX := 1 to nCopias
		...
		nLinha += nTamLim*2
		oPrint:Say(nLinha+nTamLim,nColIni,PadC(Alltrim("____/____/________"),50),oFont12n)
		oPrint:Say(nLinha+nTamLim*2,nColIni,PadC(Alltrim("DATA"),60),oFont12n) 
		oPrint:Say(nLinha+nTamLim,nColDiv1,PadC(Alltrim("__________________________________"),50),oFont12n)
		oPrint:Say(nLinha+nTamLim*2,nColDiv1,PadC(Alltrim("Assinatura do Empregado"),60),oFont12n)
		...
		while !(cAlias)->(Eof())
			...
			oPrint:Say(nLinha,nColDiv2+15,/* Alltrim((cAlias)->D3_CODCA) */"",oFont10)
