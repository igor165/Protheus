...
If cTipo == "Geral"
	...
	_cQry := " WITH CONSUMO AS (" + CRLF +;
			 ...
			 " 	         AND Z05_DIASDI   BETWEEN '" + StrZero(MV_PAR03,3) + "' and '" + StrZero(MV_PAR04,3) + "'" + CRLF +;
			 " 	         AND Z05.D_E_L_E_T_ = ' '" + CRLF +;
			 " 	  )" + CRLF +;
			 "" + CRLF +;
			 " , LOTES AS (" + CRLF +;
			 "        SELECT DISTINCT B8_LOTECTL, B8_XDATACO, B8_XPESOCO " + CRLF +;
			 ...
			 " 			" + CRLF +;
			 " )" + CRLF +;
			 " SELECT C.Z05_DATA --convert(date, C.Z05_DATA, 103) AS Z05_DATA" + CRLF +;
			 " 		, C.Z05_FILIAL" + CRLF +;
			 " 		, C.Z05_CURRAL" + CRLF +;
			 " 		, C.Z05_LOTE" + CRLF +;
			 " 		, C.Z05_CABECA" + CRLF +;
...
If !(_cAliasG)->(Eof())
	...
	While !(_cAliasG)->(Eof())
		...
		If sDataAtual <> (_cAliasG)->Z05_DATA
			...
			cXML += U_prtCellXML( 'Row' )
            cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,'09'/*cIndex*/,/*cMergeAcross*/,'s65'    , 'String', /*cFormula*/, 'GMD Estimado:'			,,.T. )
...
/* 14 */	cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,/*cIndex*/,/*cMergeAcross*/,'s65', 'String', /*cFormula*/, 'CMS %PV Atual'   ,,.T. )
		...
		cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,/*cIndex*/,/*cMergeAcross*/,'sSemDig', 'Number'  , /*cFormula*/, U_FrmtVlrExcel( (_cAliasG)->Z05_DIASDI ),,.T. ) /* 06 */
																																	...
																																	nPI_KGMSD := 15 // Inicio KG Mat Seca
																																	nPF_KGMSD := nPI_KGMSD + MV_PAR08 - 1 // Fim KG Mat Seca
