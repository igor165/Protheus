...
/*---------------------------------------------------------------------------------,
 ...
 | Data		: 22.08.2019                                                           |
 | Cliente  : V@                                                                   |
 | Desc		: Relat�rio de Desempenho Trato.       						           |
 |                                                                                 |
 |---------------------------------------------------------------------------------|
 | Regras   :                                                                      |
 |                                                                                 |
...
Private cTitulo  	:= "Relat�rio de Desempenho Trato."
...
If Pergunte(cPerg, .T.)
	...
	if nHandle = -1
		...
		FWMsgRun(, {|| lTemDados := fLoadSql("Geral", @_cAliasG ) },;
					    'Por Favor Aguarde...',; 
						'Processando Banco de Dados - Alimenta��o Di�ria')
		If lTemDados
			...
			FWMsgRun(, {|| fQuadro1() },'Gerando excel, Por Favor Aguarde...', 'Gera��o do quadro de Carregamento')
...
If cTipo == "Geral"
	...
	_cQry += "  	    		    AND Z0W.D_E_L_E_T_ = ' '	-- cabe�alho de programacao do Trato"+CRLF
	_cQry += CRLF
	...
	_cQry += " 				    AND Z0X.D_E_L_E_T_ = ' '	-- cabe�alho TRATO"+CRLF
	_cQry += CRLF
...
If !(_cAliasG)->(Eof())
	...
	cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,/*cIndex*/,/*cMergeAcross*/,'s65', 'String', /*cFormula*/, 'Manh�'				,,.T. )
