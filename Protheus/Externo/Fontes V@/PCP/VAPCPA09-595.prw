...
Local oTFntSb := TFont():New('Courier new',,16,.T.,.T.,,,,,.T.)
...
cQryRot := " SELECT Z08.Z08_CONFNA AS CONF, Z08.Z08_TIPO AS TIPO, Z08.Z08_CODIGO, Z08.Z08_LINHA AS LINHA, Z08.Z08_SEQUEN AS SEQ " + CRLF
cQryRot += "      , ISNULL(SB8.B8_LOTECTL, 'SEM LOTE') AS LOTE, Z05.Z05_CABECA AS QUANT, (SELECT DISTINCT(Z0M.Z0M_DESCRI) FROM " + RetSqlName("Z0M") + " Z0M WHERE Z0M.Z0M_CODIGO = Z0O.Z0O_CODPLA) AS PLANO " + CRLF
...
cQryRot += "      , Z05.Z05_DIETA AS DIETA, Z0R.Z0R_DATA AS DTTRT, Z0R.Z0R_VERSAO AS VERSAO, Z0T.Z0T_ROTA AS ROTA " + CRLF
...
cQryRot += "      , (SELECT COUNT(Z06.Z06_TRATO)  FROM " + RetSqlName("Z06") + " Z06 WHERE Z06.D_E_L_E_T_ <> '*' AND Z06.Z06_FILIAL = '01' AND Z06.Z06_DATA = Z0R.Z0R_DATA AND Z06.Z06_VERSAO = Z0R.Z0R_VERSAO AND Z06.Z06_LOTE = SB8.B8_LOTECTL) AS NRTRT " + CRLF
cQryRot += "      , (SELECT SUM(Z04.Z04_TOTREA)   FROM " + RetSqlName("Z04") + " Z04 WHERE Z04.Z04_DTIMP  = DATEADD(dd, -1, cast('" + DTOS(aDadSel[2]) + "' as datetime)) AND Z04.Z04_FILIAL = '01' AND Z04.D_E_L_E_T_ <> '*' AND Z04.Z04_LOTE = SB8.B8_LOTECTL) AS Z04_TOTREA " + CRLF
...
cQryRot += " GROUP BY Z08.Z08_CONFNA, Z08.Z08_TIPO, Z08.Z08_CODIGO, Z08.Z08_LINHA, Z08.Z08_SEQUEN, SB8.B8_LOTECTL, Z05.Z05_CABECA, Z0O.Z0O_CODPLA, Z05.Z05_DIETA, Z05.Z05_KGMNDI, Z05.Z05_KGMSDI, Z0R.Z0R_DATA, Z0R.Z0R_VERSAO, Z0T.Z0T_ROTA " + CRLF //SB8.B8_XDATACO,
cQryRot += " ORDER BY Z08.Z08_TIPO, Z08.Z08_CONFNA, Z08.Z08_LINHA, Z08.Z08_SEQUEN, Z08.Z08_CODIGO " + CRLF


/*
cQryRot := " WITH PROGRAMA AS (
cQryRot += " SELECT Z08.Z08_CONFNA AS CONF, Z08.Z08_TIPO AS TIPO, Z08.Z08_CODIGO, Z08.Z08_LINHA AS LINHA, Z08.Z08_SEQUEN AS SEQ " + CRLF
cQryRot += "      , ISNULL(SB8.B8_LOTECTL, 'SEM LOTE') AS LOTE, Z05.Z05_CABECA AS QUANT, (SELECT DISTINCT(Z0M.Z0M_DESCRI) FROM " + RetSqlName("Z0M") + " Z0M WHERE Z0M.Z0M_CODIGO = Z0O.Z0O_CODPLA) AS PLANO " + CRLF
cQryRot += "      , DATEDIFF(day, (SELECT MIN(SB8A.B8_XDATACO) FROM " + RetSqlName("SB8") + " SB8A WHERE SB8A.B8_LOTECTL = SB8.B8_LOTECTL AND SB8A.B8_FILIAL = '" + xFilial("SB8") + "' AND SB8A.B8_SALDO > 0 AND SB8A.D_E_L_E_T_ <> '*'),  GETDATE()) AS DIAS " + CRLF //DATEDIFF(day, SB8.B8_XDATACO,  GETDATE()) AS DIAS, 
cQryRot += "      , Z05.Z05_DIETA AS DIETA, Z0R.Z0R_DATA AS DTTRT, Z0R.Z0R_VERSAO AS VERSAO " + CRLF
cQryRot += "      , (SELECT DISTINCT(SB1.B1_DESC) FROM " + RetSqlName("SB1") + " SB1 WHERE SB1.B1_COD = Z05.Z05_DIETA) AS DIEDSC " + CRLF                                                                                                      //AND Z06.Z06_CURRAL = Z08.Z08_CODIGO                                         
cQryRot += "      , (SELECT COUNT(Z06.Z06_TRATO)  FROM " + RetSqlName("Z06") + " Z06 WHERE Z06.D_E_L_E_T_ <> '*' AND Z06.Z06_FILIAL = '01' AND Z06.Z06_DATA = Z0R.Z0R_DATA AND Z06.Z06_VERSAO = Z0R.Z0R_VERSAO AND Z06.Z06_LOTE = SB8.B8_LOTECTL) AS NRTRT " + CRLF
cQryRot += "      , (SELECT SUM(Z04.Z04_TOTREA)   FROM " + RetSqlName("Z04") + " Z04 WHERE Z04.Z04_DTIMP  = DATEADD(dd, -1, cast('" + DTOS(aDadSel[2]) + "' as datetime)) AND Z04.Z04_FILIAL = '01' AND Z04.D_E_L_E_T_ <> '*' AND Z04.Z04_LOTE = SB8.B8_LOTECTL) AS Z04_TOTREA " + CRLF
cQryRot += "      , (SELECT Z05A.Z05_KGMNDI FROM " + RetSqlName("Z05") + " Z05A WHERE Z05A.Z05_DATA = DATEADD(dd, -1, Z0R.Z0R_DATA) AND Z05A.Z05_VERSAO = Z0R.Z0R_VERSAO AND Z05A.Z05_LOTE = SB8.B8_LOTECTL AND Z05A.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05A.D_E_L_E_T_ <> '*') AS KGMN " + CRLF
cQryRot += "      , (SELECT Z05A.Z05_KGMSDI FROM " + RetSqlName("Z05") + " Z05A WHERE Z05A.Z05_DATA = DATEADD(dd, -1, Z0R.Z0R_DATA) AND Z05A.Z05_VERSAO = Z0R.Z0R_VERSAO AND Z05A.Z05_LOTE = SB8.B8_LOTECTL AND Z05A.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05A.D_E_L_E_T_ <> '*') AS KGMS " + CRLF
cQryRot += "      , (SELECT Z05A.Z05_KGMNDI FROM " + RetSqlName("Z05") + " Z05A WHERE Z05A.Z05_DATA = Z0R.Z0R_DATA AND Z05A.Z05_VERSAO = Z0R.Z0R_VERSAO AND Z05A.Z05_LOTE = SB8.B8_LOTECTL AND Z05A.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05A.D_E_L_E_T_ <> '*') AS KGMNDIA " + CRLF
cQryRot += "      , (SELECT Z05A.Z05_KGMSDI FROM " + RetSqlName("Z05") + " Z05A WHERE Z05A.Z05_DATA = Z0R.Z0R_DATA AND Z05A.Z05_VERSAO = Z0R.Z0R_VERSAO AND Z05A.Z05_LOTE = SB8.B8_LOTECTL AND Z05A.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05A.D_E_L_E_T_ <> '*') AS KGMSDIA " + CRLF
cQryRot += " FROM " + RetSqlName("Z08") + " Z08 " + CRLF
cQryRot += " LEFT JOIN " + RetSqlName("SB8") + " SB8 ON SB8.B8_X_CURRA = Z08.Z08_CODIGO AND SB8.B8_FILIAL = '" + xFilial("SB8") + "' AND SB8.D_E_L_E_T_ <> '*' AND SB8.B8_SALDO > 0 " + CRLF
...
cQryRot += "   AND Z08.Z08_MSBLQL <> '1' " + CRLF
cQryRot += IIf(!lShwZer, " AND SB8.B8_SALDO > 0 ", "") + CRLF
cQryRot += " GROUP BY Z08.Z08_CONFNA, Z08.Z08_TIPO, Z08.Z08_CODIGO, Z08.Z08_LINHA, Z08.Z08_SEQUEN, SB8.B8_LOTECTL, Z05.Z05_CABECA, Z0O.Z0O_CODPLA, Z05.Z05_DIETA, Z05.Z05_KGMNDI, Z05.Z05_KGMSDI, Z0R.Z0R_DATA, Z0R.Z0R_VERSAO " + CRLF //SB8.B8_XDATACO, , Z0T.Z0T_ROTA
cQryRot += " ) " + CRLF
cQryRot += " , DIAANT AS (  " + CRLF
cQryRot += "    SELECT DISTINCT Z0T_ROTA, Z05.Z05_LOTE, Z05.Z05_CURRAL, Z05.Z05_DIETA, Z051.Z05_DIETA DIETAD1  " + CRLF
cQryRot += "        FROM " + RetSqlName("Z05") + " Z05  " + CRLF
cQryRot += "        JOIN " + RetSqlName("Z0T") + " Z0T ON   " + CRLF
cQryRot += "             Z05_FILIAL = '" + xFilial("Z05") + "'   " + CRLF
cQryRot += "         AND Z05.Z05_LOTE = Z0T_LOTE   " + CRLF
cQryRot += "         AND Z0T_DATA = DATEADD(DAY, -1, '" + DTOS(aDadSel[2]) + "')   " + CRLF
cQryRot += "         AND Z05.D_E_L_E_T_ = ' '   " + CRLF
cQryRot += "   LEFT JOIN " + RetSqlName("Z05") + " Z051 ON   " + CRLF
cQryRot += "             Z051.Z05_FILIAL = '" + xFilial("Z05") + "'   " + CRLF
cQryRot += "   	  AND Z05.Z05_LOTE = Z051.Z05_LOTE   " + CRLF
cQryRot += "   	  AND Z051.Z05_DATA = DATEADD(DAY, -1, '" + DTOS(aDadSel[2]) + "')   " + CRLF
cQryRot += "   	  AND Z051.D_E_L_E_T_ = ' '   " + CRLF
cQryRot += "       WHERE Z05.Z05_DATA = '" + DTOS(aDadSel[2]) + "' " + CRLF
cQryRot += "         AND Z05.D_E_L_E_T_ = ' '   " + CRLF
cQryRot += "         AND Z0T.D_E_L_E_T_ = ' '   " + CRLF
cQryRot += "    GROUP BY Z0T_ROTA, Z05.Z05_DIETA, Z051.Z05_DIETA, Z05.Z05_LOTE, Z05.Z05_CURRAL  " + CRLF
cQryRot += "   	)  " + CRLF
cQryRot += "   	, ROTANDIETAS AS (   " + CRLF
cQryRot += "      SELECT DISTINCT ZRT_ROTA, COUNT(DISTINCT Z05_DIETA) QTDDIETAS  " + CRLF
cQryRot += "   	 FROM " + RetSqlName("ZRT") + "" + CRLF
cQryRot += "   	 JOIN DIAANT ON   " + CRLF
cQryRot += "   	      ZRT_ROTA = Z0T_ROTA   " + CRLF
cQryRot += "   	WHERE ZRT_FILIAL = '" + xFilial("Z0R") + "'  " + CRLF
cQryRot += "    GROUP BY ZRT_ROTA  " + CRLF
cQryRot += "    )   " + CRLF
cQryRot += "       SELECT P.*,   " + CRLF //D.Z0T_ROTA ROTA
cQryRot += "         CASE WHEN  QTDDIETAS = 1  AND P.DIETA = D.DIETAD1	 THEN Z0T_ROTA   " + CRLF
cQryRot += "	          WHEN QTDDIETAS > 1 AND P.DIETA = D.DIETAD1	THEN  Z0T_ROTA " + CRLF
cQryRot += "			  WHEN QTDDIETAS = 1 AND P.DIETA <> D.DIETAD1	THEN  Z0T_ROTA " + CRLF
cQryRot += "			  ELSE ' '   END ROTA " + CRLF
cQryRot += "         FROM PROGRAMA P  " + CRLF
cQryRot += "    LEFT JOIN DIAANT D ON  " + CRLF
cQryRot += "      		  P.LOTE = D.Z05_LOTE   " + CRLF
//cQryRot += "   	      AND P.DIETA = DIETAD1   " 
cQryRot += "    LEFT JOIN ROTANDIETAS R ON  " + CRLF
cQryRot += "			  D.Z0T_ROTA = R.ZRT_ROTA " + CRLF
//cQryRot += "		  AND R.QTDDIETAS = 1 " + CRLF
cQryRot += "     ORDER BY P.TIPO, CONF, LINHA, SEQ, P.Z08_CODIGO " + CRLF
*/
TCQUERY cQryRot NEW ALIAS "QRYROT"

MEMOWRITE("C:\TOTVS\TOTVS_RELATORIOS\ROTAMAIN.TXT", cQryRot)
...
While !(QRYROT->(EOF()))
	...
	ElseIf (QRYROT->TIPO == '4')
		//AAdd(aDdTlC, {QRYROT->LINHA, QRYROT->SEQ, ALLTRIM(QRYROT->LOTE), QRYROT->QUANT, QRYROT->PLANO, QRYROT->DIAS,  QRYROT->DIETA, ALLTRIM(QRYROT->LOTE), QRYROT->QUANT, QRYROT->PLANO, QRYROT->DIAS, QRYROT->DIETA, IIf(QRYROT->DIAS = 1, QRYROT->KGMN, QRYROT->KGMNDIA ), IIf(QRYROT->DIAS == 1, QRYROT->KGMS, QRYROT->KGMSDIA ),  QRYROT->ROTA, QRYROT->CONF, QRYROT->Z08_CODIGO,  QRYROT->DIEDSC })
...
aSort(aCrDie,,, {|x, y| x[1] < y[1]})
/*
cQryRD1 := " SELECT Z08.Z08_CONFNA AS CONF, Z08.Z08_TIPO AS TIPO, Z08.Z08_CODIGO, Z08.Z08_LINHA AS LINHA, Z08.Z08_SEQUEN AS SEQ " + CRLF
cQryRD1 += "      , ISNULL(SB8.B8_LOTECTL, 'SEM LOTE') AS LOTE, Z05.Z05_DIETA AS DIETA, (Z05.Z05_CABECA * Z05.Z05_KGMNDI) AS KGMN " + CRLF
cQryRD1 += "      , Z0R.Z0R_DATA AS DTTRT, Z0R.Z0R_VERSAO AS VERSAO, Z0T.Z0T_ROTA AS ROTA " + CRLF
cQryRD1 += " FROM " + RetSqlName("Z08") + " Z08 " + CRLF
cQryRD1 += " LEFT JOIN " + RetSqlName("SB8") + " SB8 ON SB8.B8_X_CURRA = Z08.Z08_CODIGO AND SB8.B8_FILIAL = '" + xFilial("SB8") + "' AND SB8.D_E_L_E_T_ <> '*' AND SB8.B8_SALDO > 0 " + CRLF
cQryRD1 += " LEFT JOIN " + RetSqlName("Z0R") + " Z0R ON Z0R.Z0R_DATA = '" + DTOS(DaySub(aDadSel[2],1)) + "' AND Z0R.Z0R_VERSAO = '" + aDadSel[3] + "' AND Z0R.Z0R_FILIAL = '" + xFilial("Z0R") + "' AND Z0R.D_E_L_E_T_ <> '*' " + CRLF //AND Z0R.Z0R_LOCK < '2'
cQryRD1 += " LEFT JOIN " + RetSqlName("Z05") + " Z05 ON Z05.Z05_DATA = Z0R.Z0R_DATA AND Z05.Z05_VERSAO = Z0R.Z0R_VERSAO AND Z05.Z05_LOTE = SB8.B8_LOTECTL AND Z05.Z05_CURRAL = SB8.B8_X_CURRA AND Z05.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05.D_E_L_E_T_ <> '*' " + CRLF
cQryRD1 += " LEFT JOIN " + RetSqlName("Z0T") + " Z0T ON Z0T.Z0T_DATA = Z0R.Z0R_DATA AND Z0T.Z0T_VERSAO = Z0R.Z0R_VERSAO AND Z0T.Z0T_LINHA = Z08.Z08_LINHA AND Z0T.Z0T_SEQUEN = Z08.Z08_SEQUEN AND Z0T.Z0T_FILIAL = '" + xFilial("Z0T") + "' AND Z0T.D_E_L_E_T_ <> '*' " + CRLF
cQryRD1 += " WHERE Z08.D_E_L_E_T_ <> '*' " + CRLF 
cQryRD1 += "   AND Z08.Z08_FILIAL = '" + xFilial("Z08") + "' " + CRLF 
cQryRD1 += "   AND SB8.B8_SALDO > 0 " + CRLF
cQryRD1 += "   AND Z08.Z08_CONFNA <> '' " + CRLF
cQryRD1 += "   AND Z08.Z08_MSBLQL <> '1' " + CRLF
cQryRD1 += " GROUP BY Z08.Z08_CONFNA, Z08.Z08_TIPO, Z08.Z08_CODIGO, Z08.Z08_LINHA, Z08.Z08_SEQUEN, SB8.B8_LOTECTL, Z05.Z05_DIETA, Z05.Z05_CABECA, Z05.Z05_KGMNDI, Z0R.Z0R_DATA, Z0R.Z0R_VERSAO, Z0T.Z0T_ROTA " + CRLF
cQryRD1 += " ORDER BY Z08.Z08_TIPO, Z08.Z08_CONFNA, Z08.Z08_LINHA, Z08.Z08_SEQUEN, Z08.Z08_CODIGO " + CRLF
*/
...
cQryRD1 += "       WHERE Z08.Z08_CONFNA <> ''   " + CRLF
cQryRD1 += "         AND Z08.Z08_MSBLQL <> '1'   " + CRLF
...
cQryRD1 += "             Z05_FILIAL = '" + xFilial("Z05") + "'   " + CRLF
...
cQryRD1 += "       WHERE Z05.Z05_DATA = '" + DTOS(aDadSel[2]) + "' " + CRLF
cQryRD1 += "         AND Z05.D_E_L_E_T_ = ' '   " + CRLF
...
cQryRD1 += "   	WHERE ZRT_FILIAL = '" + xFilial("Z05") + "'  " + CRLF
...
MEMOWRITE("C:\TOTVS\TOTVS_RELATORIOS\ROTAD1.TXT", cQryRD1)
...
/*
	...
	-- Inclusão da validação das dietas de acordo com a programação do trato do dia.

*/
/*
cQryDie := "         WITH ROTAS AS ( " + CRLF
cQryDie += "                SELECT ZRT_ROTA " + CRLF
cQryDie += "                  FROM " + RetSqlName("ZRT") + "  " + CRLF
cQryDie += "                 WHERE ZRT_FILIAL = '" + xFilial("ZRT") + "' " + CRLF
cQryDie += "                   AND D_E_L_E_T_ = ''  " + CRLF
cQryDie += "                ) " + CRLF
cQryDie += "                , TRATO AS ( " + CRLF
cQryDie += "                SELECT DISTINCT Z0T_ROTA, Z05_DIETA  " + CRLF
cQryDie += "                  FROM " + RetSqlName("Z0T") + " Z0T  " + CRLF
cQryDie += "                  JOIN " + RetSqlName("Z05") + " Z05 ON " + CRLF
cQryDie += "                       Z0T_FILIAL = '" + xFilial("Z0T") + "' " + CRLF
cQryDie += "                   AND Z0T_DATA = '" + DTOS(DaySub(aDadSel[2],1)) + "' " + CRLF
cQryDie += "                   AND Z05_VERSAO = Z0T_VERSAO " + CRLF
cQryDie += "				   AND Z0T_LOTE = Z05_LOTE " + CRLF
//cQryDie += "                   AND Z0T_CURRAL = Z05_CURRAL " + CRLF
cQryDie += "                   AND Z05.D_E_L_E_T_ = '' " + CRLF
cQryDie += "                 WHERE Z05_DATA = '" + DTOS(aDadSel[2]) + "' " + CRLF
cQryDie += "                   AND Z05.Z05_VERSAO ='" + aDadSel[3] + "' " + CRLF
cQryDie += "                   AND Z0T.D_E_L_E_T_ = ' '  " + CRLF
cQryDie += "                ) " + CRLF
cQryDie += "                , OPERA  AS (  " + CRLF
cQryDie += "                SELECT Z0S_ROTA, Z0S_DIETA, Z0S_EQUIP, Z0S_OPERAD " + CRLF
cQryDie += "                  FROM " + RetSqlName("Z0s") + " WHERE  " + CRLF
cQryDie += "                       Z0S_FILIAL = '" + xFilial("Z0S") + "' " + CRLF
cQryDie += "                   AND Z0S_DATA = '" + DTOS(DaySub(aDadSel[2],1)) + "' " + CRLF
cQryDie += "                   AND Z0S_VERSAO = '" + aDadSel[3] + "' " + CRLF
cQryDie += "                   AND D_E_L_E_T_ = ' ' " + CRLF
cQryDie += "                )   " + CRLF
cQryDie += "                 " + CRLF
cQryDie += "                SELECT ZRT_ROTA ROTA, ISNULL(Z05_DIETA,'') DIETA, ISNULL(Z0S_EQUIP, '') EQUIP, ISNULL(Z0S_OPERAD, '' )OPERAD  " + CRLF
cQryDie += "                  FROM ROTAS  " + CRLF
cQryDie += "             LEFT JOIN TRATO on ZRT_ROTA = Z0T_ROTA " + CRLF
cQryDie += "             LEFT JOIN OPERA ON ZRT_ROTA = Z0S_ROTA " + CRLF //--AND Z0S_DIETA = Z05_DIETA 
cQryDie += "                   AND Z0S_DIETA <> ' ' " + CRLF
cQryDie += "                ORDER BY 1 " + CRLF
*/
...
cQryDie += "       WHERE Z08.Z08_CONFNA <> '' AND Z08.Z08_MSBLQL <> '1' AND B8_SALDO > 0 AND Z08.D_E_L_E_T_ = ' '   " + CRLF
cQryDie += "     )  " + CRLF
...
cQryDie += "        JOIN " + RetSqlName("Z0T") + " Z0T ON Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05.Z05_LOTE = Z0T_LOTE AND Z0T_DATA = DATEADD(DAY, -1, '" + DTOS(aDadSel[2]) + "') AND Z05.D_E_L_E_T_ = ' '   " + CRLF
...
cQryDie += "       WHERE Z05.Z05_DATA = '" + DTOS(aDadSel[2]) + "' AND Z05.D_E_L_E_T_ = ' ' AND Z0T.D_E_L_E_T_ = ' '   " + CRLF
...
cQryDie += " LEFT JOIN Z0S010 Z0S ON " + CRLF
...
MEMOWRITE("C:\TOTVS\TOTVS_RELATORIOS\ROTAS_PROGR-"+ DTOS(aDadSel[2]) +".TXT", cQryDie)
...
//MsgInfo("aSize[1] " + STR(aSize[1]) + " - aSize[2] " + STR(aSize[2]) + CRLF + "aSize[3] " + STR(aSize[3]) + " - aSize[4] " + STR(aSize[4]) + CRLF + "aSize[5] " + STR(aSize[5]) + " - aSize[6] " + STR(aSize[6]) + CRLF + " - aPObjs[1][1] " + STR(aPObjs[1][1]) + " - aPObjs[1][2] " + STR(aPObjs[1][2]) + CRLF + " - aPObjs[1][3] " + STR(aPObjs[1][3]) + " - aPObjs[1][4] " + STR(aPObjs[1][4]))

nColLeg := (aPObjs[1][4]/2) - 080 //nColLeg := aSize[6] - 460
...
DEFINE MSDIALOG oDlgRotas TITLE OemToAnsi("Rotas do Trato") From aPObjs[1][1], aPObjs[1][2] To aPObjs[1][3], aPObjs[1][4] of oDlgRotas PIXEL 
 	...
 	//TGet():New(015, 005, {|u| If(PCount() == 0, dDtTrt, dDtTrt := u ) }, oDlgRotas, 100, 016, "@D",,,,oTFntGr,.F.,,.T.,,.F.,,.F.,.F.,,.F.,.F. ,,"dDtTrt",,,,lHasButton  )
 	...
 	TSay():New(035, 005, {|| "Total Selecionado Trato:"}, oDlgRotas,,oTFntLg,,,,.T., CLR_BLACK, CLR_WHITE, 200, 20)
 	oTSTotTr := TSay():New(035, 120, {|| TRANSFORM(nTotTrt, "@E 999,999,999.99")}, oDlgRotas,,oTFntLg,,,,.T., CLR_RED, CLR_WHITE, 200, 20)
 
 	//TSay():New(048, 005, {|| "Lotes mudanca Curral:"}, oDlgRotas,,oTFntLg,,,,.T., CLR_BLACK, CLR_WHITE, 100, 20)
 	//oTSChgCur := TSay():New(048, 120, {|| cChgCur}, oDlgRotas,,oTFntLg,,,,.T., CLR_RED, CLR_WHITE, (aPObjs[1][4]/2), 10)
 
 	//TSay():New(061, 005, {|| "Lotes mudanca Dieta:"}, oDlgRotas,,oTFntLg,,,,.T., CLR_BLACK, CLR_WHITE, 100, 20)
 	//oTSChgDie := TSay():New(061, 120, {|| cChgDie}, oDlgRotas,,oTFntLg,,,,.T., CLR_RED, CLR_WHITE, (aPObjs[1][4]/2), 10)
 	...
 	For nCntAll := 1 To Len(aCrDie)
 		...
 		EndIf
 	 	...
 	 	TSay():New(nLinLeg, nColLeg, &("{|| '" + ALLTRIM(cDscDie) + "'}"), oDlgRotas,,oTFntLg,,,,.T., aCrDie[nCntAll][2], CLR_WHITE, 080, 15)
...
//	For nCntAll := 1 To Len(aRot)
//	
//		If (POSICIONE("Z0S", 1, xFilial("Z0S")+DTOS(aDadSel[2])+aDadSel[3]+aRot[nCntAll][1], "Z0S_TOTTRT") > 0)
//			TSay():New(nLinLeg, nColLeg, &("{|| '" + ALLTRIM(aRot[nCntAll][1]) + "'}"), oDlgRotas,,oTFntLg,,,,.T., aRot[nCntAll][2], CLR_BLACK, 040, 20)
//			nColLeg += 40
//		EndIf
//	
//	Next nCntAll
	...
	Z0S->(DBSeek(xFilial("Z0S")+DTOS(aDadSel[2])+aDadSel[3]+aDadSel[1]))
 	...
 	//If (lPShwGer)
 	// 	TPanel():New(001, 001,, oScrRot, oTFntPs, .T.,, aCorTl[4], aCorTl[1], (aPObjs[1][3]/2), (aPObjs[1][4]/2))
 	//Else
...
//		cDsCur := ALLTRIM(STR(aDdTlC[nCntAll][06]))
		...
		If (lPShwGer)
			...
			If (cQtCab != '0')
				...
				//aCurPst[nChvCur]:bLClicked := &("{|| (U_SelCur('  ', '" + aDdTlC[nCntAll][01] + "', '" + aDdTlC[nCntAll][02] + "', .T.))}")
		...
		ElseIf (IIf(oTFldr:nOption = (Len(oTFldr:aDialogs) - 1), aDdTlC[nCntAll][11] = "99", aDdTlC[nCntAll][11] = aDadSel[4]))
			...
			If (cQtCab != '0')
				...
				aCurPst[nChvCur]:bLClicked := &("{|| (U_SelCur('" + aDdTlC[nCntAll][11] + "', '" + aDdTlC[nCntAll][01] + "', '" + STR(nChvCur) + "', .T.))}")
//				aCurPst[nChvCur]:bLClicked := &("{|| (U_SelCur('" + cChvCnf + "', '" + Space(10) + "', '" + STR(nChvCur) + "', .T.))}")
				aCurPst[nChvCur - 1]:TagGroup := 1
				AAdd(aCurPst[nChvCur]:aControls, (aDdTlC[nCntAll][08] * aDdTlC[nCntAll][04]))
				AAdd(aCurPst[nChvCur]:aControls, (aDdTlC[nCntAll][01]))
				AAdd(aCurPst[nChvCur]:aControls, (aDdTlC[nCntAll][02]))
...
//				TSay():New(005, 040, &("{|| '" + cQtCab + "'}"), aCurPst[nChvCur],,oTFntSb,,,,.T., aCorTl[5], aCrDie[nCrAux][2], 200, 20)
//				TSay():New(015, 005, &("{|| '" + cPlCur + "'}"), aCurPst[nChvCur],,oTFntGr,,,,.T., aCorTl[5], aCrDie[nCrAux][2], 200, 40)
//				TSay():New(025, 005, &("{|| '" + cDsCur + "'}"), aCurPst[nChvCur],,oTFntGr,,,,.T., aCorTl[5], aCrDie[nCrAux][2], 200, 20)
...
//			AAdd(aHdrRes, {"Descricao"  , "DSCDIE" , ""                 , 40, 0, ""                      , "", "C", ""      , "R", "", "", "", "V"})
            ...
            cQryRes := " with ROT as (" +;
                           " select Z0T.Z0T_ROTA, Z05.Z05_DIETA, sum(Z05.Z05_KGMNDI*Z05.Z05_CABECA) TOTTRT" +;
                             " from " + RetSqlName("Z05") + " Z05" +;
                             " join " + RetSqlName("Z0T") + " Z0T" +;
                               " on Z0T.Z0T_FILIAL = Z05.Z05_FILIAL" +;
                              " and Z0T.Z0T_DATA   = Z05.Z05_DATA" +;
                              " and Z0T.Z0T_VERSAO = Z05.Z05_VERSAO" +;
                              " and Z0T.Z0T_CURRAL = Z05.Z05_CURRAL" +;
                              " and Z0T.Z0T_ROTA   <> '      '" +;
                              " and Z0T.D_E_L_E_T_ = ' '" +;
                            " where Z05.Z05_FILIAL = '" + FWxFilial("Z05") + "'" +;
                              " and Z05.Z05_DATA   = '" + DTOS(aDadSel[2]) + "'" +;
                              " and Z05.Z05_VERSAO = '" + aDadSel[3] + "'" +;
                              " and Z05.D_E_L_E_T_ = ' '" +;
                         " group by Z0T.Z0T_ROTA, Z05.Z05_DIETA" +;
                       " )" +;
                           " select DISTINCT Z0S.Z0S_ROTA AS ROTA" +;
                                " , case Z0S.Z0S_DIETA when '' then ROT.Z05_DIETA else Z0S.Z0S_DIETA end AS DIETA" +;
                                " , case Z0S.Z0S_DIETA when '' then ROT.TOTTRT else Z0S.Z0S_TOTTRT end AS TOTTRT" +;
                                " , Z0S.Z0S_EQUIP AS EQUIP" +;
                                " , case Z0S.Z0S_DIETA when '' then '                              ' else Z0S.Z0S_OPERAD end AS OPERAD" +;
                                " , case Z0S.Z0S_DIETA when '' then 0 else ZV0.ZV0_CAPACI end AS CAPAC" +;
                             " from " + RetSqlName("Z0S") + " Z0S" +;
                        " left join " + RetSqlName("ZV0") + " ZV0" +;
                               " on ZV0.ZV0_FILIAL = '" + FWxFilial("Z0V") + "'" +;
                              " and ZV0.ZV0_CODIGO = Z0S.Z0S_EQUIP" +;
                              " and ZV0.ZV0_STATUS = 'A'" +;
                              " and ZV0.D_E_L_E_T_ <> '*'" +;
                        " left join ROT" +;
                               " on ROT.Z0T_ROTA   = Z0S.Z0S_ROTA" +;
                            " where Z0S.Z0S_FILIAL = '" + FWxFilial("Z0S") + "'" +;
                              " and Z0S.Z0S_DATA   = '" + DTOS(aDadSel[2]) + "'" +;
                              " and Z0S.Z0S_VERSAO = '" + aDadSel[3] + "'" +;
                              " and (" +;
                                        " Z0S.Z0S_TOTTRT > 0 " +;
                                     " or Z0S_ROTA in (" +;
                                                  " select distinct Z0T_ROTA " +;
                                                    " from " + RetSqlName("Z0T") +;
                                                   " where Z0T_FILIAL = '" + FWxFilial("Z0T") + "'" +;
                                                     " and Z0T_DATA = '" + DTOS(aDadSel[2]) + "'" +;
                                                     " and Z0T_VERSAO = '" + aDadSel[3] + "'" +;
                                                     " and D_E_L_E_T_ = ' '" +;
                                                    " )" +;
                                  " )" +;
                              " and Z0S.D_E_L_E_T_ <> '*'" 

			// // cQryRes := " SELECT Z0S.Z0S_ROTA AS ROTA, Z0S.Z0S_DIETA AS DIETA, Z0S.Z0S_TOTTRT AS TOTTRT, Z0S.Z0S_EQUIP AS EQUIP, Z0S.Z0S_OPERAD AS OPERAD, ZV0.ZV0_CAPACI AS CAPAC, ISNULL(Z0X.Z0X_STATUS, 'E') AS STATUS, Z0X.Z0X_CODIGO AS CODARQ " + CRLF
			// cQryRes := " SELECT Z0S.Z0S_ROTA AS ROTA, Z0S.Z0S_DIETA AS DIETA, Z0S.Z0S_TOTTRT AS TOTTRT, Z0S.Z0S_EQUIP AS EQUIP, Z0S.Z0S_OPERAD AS OPERAD, ZV0.ZV0_CAPACI AS CAPAC " + CRLF
			// cQryRes += " FROM " + RetSqlName("Z0S") + " Z0S " + CRLF
			// // cQryRes += " LEFT JOIN " + RetSqlName("Z0X") + " Z0X ON Z0X.Z0X_DATA = Z0S.Z0S_DATA AND Z0X.Z0X_VERSAO = Z0S.Z0S_VERSAO AND Z0X.Z0X_EQUIP = Z0S.Z0S_EQUIP AND Z0X.Z0X_FILIAL = '" + xFilial("Z0X") + "' AND Z0X.D_E_L_E_T_ <> '*' " + CRLF
			// cQryRes += " LEFT JOIN " + RetSqlName("ZV0") + " ZV0 ON ZV0.ZV0_CODIGO = Z0S.Z0S_EQUIP AND ZV0.ZV0_FILIAL = '" + xFilial("ZV0") + "' AND ZV0.D_E_L_E_T_ <> '*' AND ZV0.ZV0_STATUS = 'A' " + CRLF
			// //cQryRes += " RIGHT JOIN " + RetSqlName("Z0T") + " Z0T ON Z0T.Z0T_DATA = Z0S.Z0S_DATA AND Z0T.Z0T_VERSAO = Z0S.Z0S_VERSAO AND Z0T.Z0T_FILIAL = '" + xFilial("Z0T") + "' AND Z0T.D_E_L_E_T_ <> '*' AND Z0T.Z0T_ROTA <> ' ' " + CRLF
			// cQryRes += " WHERE Z0S.Z0S_FILIAL = '" + xFilial("Z0S") + "' " + CRLF
			// cQryRes += "    AND Z0S.D_E_L_E_T_ <> '*' " + CRLF
			// cQryRes += "    AND Z0S.Z0S_DATA = '" + DTOS(aDadSel[2]) + "' " + CRLF 
			// cQryRes += "    AND Z0S.Z0S_VERSAO = '" + aDadSel[3] + "' " + CRLF
			// cQryRes += "    AND Z0S.Z0S_TOTTRT > 0 " + CRLF
			...
			//	DO CASE
			//        CASE (QRYRES->STATUS = 'E')
			//            cStts := "Em Edição"
			//        CASE (QRYRES->STATUS = 'G')
			//            cStts := "Arquivo Gerado"
			//        CASE (QRYRES->STATUS = 'A')
			//            cStts := "Import.Parcial"
			//        CASE (QRYRES->STATUS = 'I')
			//            cStts := "Import.Total"
			//        CASE (QRYRES->STATUS = 'C')
			//            cStts := "Conferido"
			//        CASE (QRYRES->STATUS = 'B')
			//            cStts := "Proces.Parcial"
		    //        CASE (QRYRES->STATUS = 'P')
			//            cStts := "Processado"
			//        OTHERWISE
			//            cStts := "Em Edição"
	        //    ENDCASE
			//
			//	cStts := IIf(QRYRES->STATUS = 'E', "Em edicao", "Arquivo Gerado")
...
//If (!Empty(cCur))
//	
//	If ((nIndAux := aScan(aChgCur, {|x| ALLTRIM(x[5]) = cCur})) > 0)
//		aDel(aChgCur, nIndAux)
//		aSize(aChgCur, Len(aChgCur) - 1)
//	EndIf
//		
//	nIndAux := 0
//	
//	If ((nIndAux := aScan(aChgDie, {|x| ALLTRIM(x[5]) = cCur})) > 0)
//		aDel(aChgDie, nIndAux)
//		aSize(aChgDie, Len(aChgDie) - 1)
//	EndIf
//	
//EndIf
//
//cChgCur := ""
//
//For nCntAll := 1 To Len(aChgCur)
//	cChgCur := cChgCur + ALLTRIM(aChgCur[nCntAll][01]) + "(" + ALLTRIM(aChgCur[nCntAll][05]) + ") | "
//Next
//
//cChgDie := ""
//
//For nCntAll := 1 To Len(aChgDie)
//	cChgDie := cChgDie + ALLTRIM(aChgDie[nCntAll][01]) + "(" + ALLTRIM(aChgDie[nCntAll][05]) + ") | "
//Next
//
//Return (Nil)
...
If (Len(aClsRes) > 0)
	...
	cQryTrR += " FROM " + RetSqlName("Z06") + " Z06 " + CRLF
	cQryTrR += " RIGHT JOIN " + RetSqlName("Z0T") + " Z0T ON Z0T.Z0T_DATA = Z06.Z06_DATA AND Z0T.Z0T_VERSAO = Z06.Z06_VERSAO AND Z0T.Z0T_FILIAL = '" + xFilial("Z0T") + "' AND Z0T.D_E_L_E_T_ <> '*' AND Z0T.Z0T_ROTA = '" + aClsRes[nLin][1] + "' " + CRLF
	cQryTrR += " WHERE Z06.Z06_FILIAL = '" + xFilial("Z06") + "' AND Z06.D_E_L_E_T_ <> '*' " + CRLF
	cQryTrR += "   AND Z06.Z06_DATA = DATEADD(dd, -1, cast('" + DTOS(aDadSel[2]) + "' as datetime)) " + CRLF
	cQryTrR += "   AND Z06.Z06_VERSAO = '" + aDadSel[3] + "' " + CRLF
	cQryTrR += "   AND Z06.Z06_TRATO <> '' " + CRLF
	cQryTrR += " GROUP BY Z06.Z06_TRATO " + CRLF
	cQryTrR += " ORDER BY Z06.Z06_TRATO "
...
cQrySCR += "     , (SELECT Z05A.Z05_KGMNDI FROM " + RetSqlName("Z05") + " Z05A WHERE Z05A.Z05_DATA = DATEADD(DAY, -1, Z0T.Z0T_DATA) AND Z05A.Z05_VERSAO = Z0T.Z0T_VERSAO AND Z05A.Z05_LOTE = Z0T.Z0T_LOTE AND Z05A.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05A.D_E_L_E_T_ <> '*') AS TOTKMN " + CRLF
cQrySCR += "     , (SELECT Z05B.Z05_CABECA FROM " + RetSqlName("Z05") + " Z05B WHERE Z05B.Z05_DATA = DATEADD(DAY, -1, Z0T.Z0T_DATA) AND Z05B.Z05_VERSAO = Z0T.Z0T_VERSAO AND Z05B.Z05_LOTE = Z0T.Z0T_LOTE AND Z05B.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05B.D_E_L_E_T_ <> '*') AS TOTCAB " + CRLF
cQrySCR += " FROM " + RetSqlName("Z0T") + " Z0T " + CRLF
cQrySCR += " LEFT JOIN " + RetSqlName("Z05") + " Z05 ON Z05.Z05_DATA = Z0T.Z0T_DATA AND Z05.Z05_VERSAO = Z0T.Z0T_VERSAO AND Z05.Z05_LOTE = Z0T.Z0T_LOTE AND Z05.Z05_FILIAL = '" + xFilial("Z05") + "' AND Z05.D_E_L_E_T_ <> '*' " + CRLF
cQrySCR += " WHERE Z0T.Z0T_FILIAL = '" + xFilial("Z0T") + "' " + CRLF
cQrySCR += "   AND Z0T.Z0T_DATA = '" + DTOS(aDadSel[2]) + "' " + CRLF
cQrySCR += "   AND Z0T.Z0T_VERSAO = '" + aDadSel[3] + "' " + CRLF
cQrySCR += "   AND Z0T.Z0T_ROTA = '" + aDadSel[1] + "' " + CRLF
cQrySCR += "   AND Z0T.D_E_L_E_T_ <> '*' " + CRLF
cQrySCR += " ORDER BY Z0T.Z0T_CURRAL "

MEMOWRITE("C:\TOTVS\TOTVS_RELATORIOS\CURROTA.TXT", cQrySCR)
