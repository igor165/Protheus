...
STATIC FUNCTION GeraX1(cPerg)
    ...
    AADD(aRegs,{cPerg,"03","Corretor           ?",Space(20),Space(20),"mv_ch3", TamSX3("ZCC_CODCOR")[3], TamSX3("ZCC_CODCOR")[1], TamSX3("ZCC_CODCOR")[2],0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
    AADD(aRegs,{cPerg,"04","Bov de             ?",Space(20),Space(20),"mv_ch4", TamSX3("D1_COD")    [3], TamSX3("D1_COD")    [1], TamSX3("D1_COD")    [2],0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
    AADD(aRegs,{cPerg,"05","Bov ate            ?",Space(20),Space(20),"mv_ch5", TamSX3("D1_COD")    [3], TamSX3("D1_COD")    [1], TamSX3("D1_COD")    [2],0,"G","","mv_par06","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
    AADD(aRegs,{cPerg,"06","Pedido de          ?",Space(20),Space(20),"mv_ch6", TamSX3("D1_PEDIDO") [3], TamSX3("D1_PEDIDO") [1], TamSX3("D1_PEDIDO") [2],0,"G","","mv_par07","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
    AADD(aRegs,{cPerg,"07","Pedido ate         ?",Space(20),Space(20),"mv_ch7", TamSX3("D1_PEDIDO") [3], TamSX3("D1_PEDIDO") [1], TamSX3("D1_PEDIDO") [2],0,"G","","mv_par08","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})	
...
STATIC FUNCTION fLoadSQL(cTipo, _cAlias)
    ...
    IF cTipo == "Corretor"   
       ...
       _cQry += "    AND D1_EMISSAO BETWEEN '" + mv_par01 + "' AND '" + mv_par02 + "'" + CRLF 
       _cQry += "    AND ZCC_CODCOR = '" + mv_par03 + "'" + CRLF 
       _cQry += "    AND D1_PEDIDO BETWEEN '" + mv_par06+ "' AND '" + mv_par07 + "'" + CRLF
       _cQry += "    AND D1_COD BETWEEN '" + mv_par04 + "' AND '" + mv_par05+ "'" + CRLF
...
STATIC FUNCTION fQuadro1()//Quadro de Carregamento
    ...
    IF  !(_cAliasC)->(DbGoTop())
        ...
        cXML += ' <Column ss:Width="235.5"/>' + CRLF
        cXML += ' <Column ss:Width="124.5"/>' + CRLF
        ...
        cXML += ' <Column ss:Width="134.25"/>' + CRLF
