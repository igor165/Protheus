...
STATIC FUNCTION fQuadro1()//Quadro de Carregamento
 ...
 //       cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,'1'/*cIndex*/,'16'/*cMergeAcross*/,'s65', 'String', /*cFormula*/, ''                     ,,.T. )
        cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,'18'/*cIndex*/,'1'/*cMergeAcross*/,'s65', 'String', /*cFormula*/, 'Caminhão Carregado'   ,,.T. )
        cXML += U_prtCellXML( '</Row>' )
    ENDIF
...
/*15*/  cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,/*cIndex*/,/*cMergeAcross*/,'s65', 'String', /*cFormula*/, 'Tolper'		            ,,.T. )
...
/*19*/  cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,/*cIndex*/,/*cMergeAcross*/,'sTexto', 'String',  /*cFormula*/, U_FrmtVlrExcel( (_cAliasC)->Z0U_NOME)  			,,.T. )/**/     
    ...
    ENDDO
        ...
        cXML += '   <TopRowBottomPane>132</TopRowBottomPane>' + CRLF
        ...
        cXML += '     <ActiveRow>104</ActiveRow>' + CRLF
...
/*14*/  cXML += U_prtCellXML( 'Cell'/*cTag*/,/*cName*/,/*cHeight*/,/*cIndex*/,/*cMergeAcross*/,'s65', 'String', /*cFormula*/, 'Tolper'		            ,,.T. )
