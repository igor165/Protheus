...
STATIC FUNCTION GeraX1(cPerg)
	...
	AADD(aRegs,{cPerg,"03","Fornecedor de      ?",Space(20),Space(20),"mv_ch3", TamSX3("ZCC_CODFOR")[3], TamSX3("ZCC_CODFOR")[1], TamSX3("ZCC_CODFOR")[2],0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
	AADD(aRegs,{cPerg,"04","Fornecedor ate     ?",Space(20),Space(20),"mv_ch4", TamSX3("ZCC_CODFOR")[3], TamSX3("ZCC_CODFOR")[1], TamSX3("ZCC_CODFOR")[2],0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
...
STATIC FUNCTION fLoadSQL(cTipo, _cAlias)
    ...
    IF cTipo == "Geral"
        ...
        _cQry   += "            AND ZBC.ZBC_CODFOR BETWEEN '"+ mv_par03 + "' AND '" + mv_par04 +"'"+ CRLF
