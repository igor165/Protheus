...
aPPA := {;
	...
	{4,4,2,1,2,'C','@!',"Dt.emissใo:"+CHR(13) + CHR(10)+transform(SA1->A1_MDTEXRG,"@D")},;
	{4,4,3,1,2,'C','@!',"ำrgใo Exp:"+CHR(13) + CHR(10)+SA1->A1_MORGEXP}}
...
{3,3,0,2,2,'C','@!',"CNPJ: "+SA1->A1_CGC},{3,3,2,2,2,'C','@!',"Data Funda็ใo: "+transform(SA1->A1_DTNASC,"@D")},{3,3,4,3,2,'C','@!',"Nบ de Registro na Junta Comercial: "+transform(SA1->A1_MNRJCOM,"99999")},{3,3,7,1.2,2,'C','@!',"Data de registro: "+transform(SA1->A1_MDRJCOM,"@D")},;
...
{3,16,0,8.2,1,'C','@!',"Site: "+SA1->A1_MSITE},;
{3,17,0,8.2,1,'C','@!',"Sucessora de: "+SA1->A1_MSUCDE}}
...
cQuery += "WHERE " 
cQuery += "SA1.A1_FILIAL='"+ xFilial("SA1")+ "' AND SA1.A1_COD = '"+cCod+"' AND SA1.A1_MTIPCLI = '2' AND "
...
Next                  
aPPA := {;
{3,y,0,2,1,'C','@!',"GRUPO EMPRESARIAL: "+SA1->A1_MGRUEMP}}
if y >= 35
	FS_RUBRICA(3,1)
Endif 
...
{3,y+19,0,2,1,'C','@!',"Cliente possui limite de cr้dito "+cLC},{3,y+19,2,2,1,'C','@!',"Qual valor? R$ "+transform(SA1->A1_LC,"@E 999,999,999.99")},{3,y+19,4,4.2,1,'C','@!',"O produtor ้ cliente do concessionแrio hแ quanto tempo?: "+transform((dDatabase - SA1->A1_MDATCAD),"999999")+" dias" },;
...
Do While !( cAliasVMK )->( Eof() )
   ...
   Aadd(aCulturas,{( cAliasVMK )->VMK_CODCUL,VX5->VX5_DESCRI,( cAliasVMK )->VMK_ARECUL,VMJ->VMJ_DESREG,( cAliasVMK )->VMK_PRODUC,( cAliasVMK )->VMK_UNIDAD,( cAliasVMK )->VMK_INIPLA,( cAliasVMK )->VMK_FIMPLA,( cAliasVMK )->VMK_INICOL,( cAliasVMK )->VMK_FIMCOL,( cAliasVMK )->VMK_CUSPRV})
...
( cAliasVMK )->( dbCloseArea() )
/*
cQuery := "SELECT VMK.VMK_CODCUL,VX5.VX5_DESCRI,VMK.VMK_ARECUL,VMJ.VMJ_DESREG,VMK.VMK_PRODUC,VMK.VMK_UNIDAD,VMK.VMK_INIPLA,VMK.VMK_FIMPLA,VMK.VMK_INICOL,VMK.VMK_FIMCOL,VMK.VMK_CUSPRV "
cQuery += "FROM "
cQuery += RetSqlName( "VMJ" ) + " VMJ " 
cQuery += "INNER JOIN "+RetSqlName("VMK")+" VMK ON (VMK.VMK_FILIAL='"+xFilial("VMK")+"' AND VMJ.VMJ_CODSEQ = VMK.VMK_PAISEQ AND VMK.VMK_FIMCOL <= '"+dtos(dDat)+"' AND  VMK.D_E_L_E_T_=' ') "
...
Do While !( cAliasVMJ )->( Eof() )
   
   Aadd(aCulturas,{( cAliasVMJ )->VMK_CODCUL,( cAliasVMJ )->VX5_DESCRI,( cAliasVMJ )->VMK_ARECUL,( cAliasVMJ )->VMJ_DESREG,( cAliasVMJ )->VMK_PRODUC,( cAliasVMJ )->VMK_UNIDAD,( cAliasVMJ )->VMK_INIPLA,( cAliasVMJ )->VMK_FIMPLA,( cAliasVMJ )->VMK_INICOL,( cAliasVMJ )->VMK_FIMCOL,( cAliasVMJ )->VMK_CUSPRV})

   dbSelectArea(cAliasVMJ)
   ( cAliasVMJ )->(dbSkip())
...
cQuery := "SELECT VMK.VMK_FIMPLA,VMK.VMK_FIMCOL,VMK.VMK_CODCUL,VX5.VX5_DESCRI,VMK.VMK_ARECUL,VMK.VMK_PRODUC,VMK.VMK_UNIDAD,VMK.VMK_VUNIVD,VMK.VMK_CUSPRV,VMK.VMK_ESTOQU "
cQuery += "FROM "
cQuery += RetSqlName( "VMK" ) + " VMK " 
cQuery += "LEFT JOIN "+RetSqlName("VX5")+" VX5 ON (VX5.VX5_FILIAL='"+xFilial("VX5")+"' AND VX5.VX5_CHAVE = '003' AND VX5.VX5_CODIGO = VMK.VMK_CODCUL AND  VX5.D_E_L_E_T_=' ') "
cQuery += "WHERE " 
...
Do While !( cAliasVMK )->( Eof() )
   ...
   Aadd(aProducao,{( cAliasVMK )->VMK_FIMPLA,( cAliasVMK )->VMK_FIMCOL,( cAliasVMK )->VMK_CODCUL,( cAliasVMK )->VX5_DESCRI,( cAliasVMK )->VMK_ARECUL,( cAliasVMK )->VMK_PRODUC,( cAliasVMK )->VMK_UNIDAD,( cAliasVMK )->VMK_VUNIVD,( cAliasVMK )->VMK_CUSPRV,( cAliasVMK )->VMK_ESTOQU})
