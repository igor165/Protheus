...
oReport := TReport():New("ROMBALCAO",;
	"Romaneio de Saída de Peças",;
	IIf( lNaoAuto , "ROMBAL" , ),;
	{|oReport| ReportPrint(oReport,cAliasQry)},;
	"Este relatório irá imprimir as peças que foram vendidas")
...
//³                                                                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oSection1 := TRSection():New(oReport,"Romaneio de Saída de Peças",{"SF2","SA1","SA3"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)	// "Romaneio de Saída de Peças"
...
TRCell():New(oSection1,"cNUMORC"	,,"Orçamento(s)",,120,/*lPixel*/,/*{|| FS_LEVORC()  }*/,,,,.t.)
...
TRCell():New(oSection2,"CLOCALIZA"	,/*Tabela*/	,"Localizacao"			,PesqPict("SB5","B5_LOCALI2")	,TamSx3("B5_LOCALI2")[1],/*lPixel*/,{|| (cAliasQry)->D2_LOCALIZ },,,,) 		    // "Localização"
...
If Empty(cOrc)
	cOrc := "Nota fiscal sem orçamento relacionado"
EndIf
