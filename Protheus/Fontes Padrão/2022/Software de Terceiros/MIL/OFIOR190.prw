...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³ValidPerg ºAutor  ³Thiago              º Data ³  10/01/12   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Perguntes                                                  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºUso       ³ Oficina                                                    º±±
...
aAdd(aRegs,{cPerg,"26",,,,,,90,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,})
aAdd(aRegs,{cPerg,"27",STR0046,"","","mv_chr","C",1 ,0,2,"C","","mv_par27","Veic Passeio","","","","","Caminh/Onibus","","","","","Apenas Caminh.","","","","","Apenas Onibus","","","","","","","","","",""})  // "Divisao            ?"
aAdd(aRegs,{cPerg,"28",STR0047,"","","mv_chs","C",30,0,0,"G","","mv_par28",,,,,,,,,,,,,,,,,,,,,,,,,,}) //"Codigo Caminhoes   ?"
aAdd(aRegs,{cPerg,"29",STR0048,"","","mv_cht","C",30,0,0,"G","","mv_par29",,,,,,,,,,,,,,,,,,,,,,,,,,}) //"Codigo Onibus      ?"
aAdd(aRegs,{cPerg,"30",STR0049,"","","mv_chu","C",30,0,0,"G","","mv_par30",,,,,,,,,,,,,,,,,,,,,,,,,,}) //"Codigo Veic.Passeio?"
aAdd(aRegs,{cPerg,"31",STR0050,"","","mv_chv","C",70,0,0,"G","","mv_par31",,,,,,,,,,,,,,,,,,,,,,,,,,}) //"Deslocamento"
aAdd(aRegs,{cPerg,"32",STR0052,"","","mv_chv","C",70,0,0,"G","","mv_par32",,,,,,,,,,,,,,,,,,,,,,,,,,}) //Interno Reparos
aAdd(aRegs,{cPerg,"33",STR0057,"","","mv_chx","C",70,0,0,"G","","mv_par33",,,,,,,,,,,,,,,,,,,,,,,,,,}) //Marca
/*
aAdd(aRegs,{cPerg,"28",STR0047,"","","mv_chs","C",30,0,0,"G","","mv_par28","","","","","","","","","","","","","","","","","","","","","","","","","",""}) //"Codigo Caminhoes   ?"
aAdd(aRegs,{cPerg,"29",STR0048,"","","mv_cht","C",30,0,0,"G","","mv_par29","","","","","","","","","","","","","","","","","","","","","","","","","",""}) //"Codigo Onibus      ?"
aAdd(aRegs,{cPerg,"30",STR0049,"","","mv_chu","C",30,0,0,"G","","mv_par30","","","","","","","","","","","","","","","","","","","","","","","","","",""}) //"Codigo Veic.Passeio?"
...
dbSelectArea("SX1")
dbSetOrder(1)
If dbSeek("OFR190"+space(len(SX1->X1_GRUPO)-6)+"06")
	If Alltrim(SX1->X1_PERGUNT) <> STR0056
		RecLock("SX1",.f.)
		SX1->X1_PERGUNT := STR0056
		SX1->X1_PERSPA  := STR0056
		SX1->X1_PERENG  := STR0056
		MsUnlock()
	Endif
Endif
