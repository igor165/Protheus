...
Method ValidBusiness() Class MntVeiculo
	...
	If ::IsValid() .And. ::IsDelete()
		...
		If ::GetValue('T9_CATBEM') == '2' //Verifica se a categoria do bem é "Frota Integrada ao TMS".
			If !StaticCall( OMSA060,PosVldMdl,oModelTMS ) //Executa a função 'PosVldMdl()', validando integração.
