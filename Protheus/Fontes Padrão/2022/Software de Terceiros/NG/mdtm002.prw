...
Static Function fGetDiagn( cAcidente )
	...
	If lAchou .And. ( IsInCallStack( "MDTR832" ) .Or. !( lDiagnostico .And. lExclu ) ) //Caso ache o registro e não for exclusão de diagnóstico
...
Static Function fGetAtest( cAcidente )
	...
	If lAchou .And. ( IsInCallStack( "MDTR832" ) .Or. !( lAtestado .And. lExclu ) ) //Caso ache o registro e não for exclusão de atestado
