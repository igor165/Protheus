...
#Define _cGradient "1,0,0,0,0,0.0,#FFFFFF120"
...
@param oWnd		, Objeto			, Janela onde o objeto será criado
@param nWidPL	, Numerico			, Largura do painel.
@param nTopPl	, Numerico			, Altura do painel.
@param nQtdMin	, Numerico			, Quantidade de shapes por linha
@param bDblClick, Bloco de codigo	, Duplo clique
@param bRClick	, Bloco de codigo	, Clique da direita

@sample New( oMainWind , 50, 80, 12, {|| .T.},{|| .F.} )
...
/*/
//---------------------------------------------------------------------
Method New( oWnd, nWidPL, nTopPl, nQtdMin , bDblClick , bRClick ) Class TNGAG
	...
	::oTPanel := TPaintPanel():New( 0 , 0 , 300 , 200 , ::oWnd )
		...
		::oTPanel:blDblClick := bDblClick//{|x,y| fDblClick(x,y,::oTPanel) }
...
Method SetDescriShp( nId , cText , cHora ) Class TNGAG
	...
	::oTPanel:addShape( "id="+cIdTxt+";type=7;"+;
							...
							"font=arial,08,0,0,3;"+"text=" + cText + ";pen-color=#434657;pen-width=2;"+;
							"gradient=1,0,0,0,0,0,#434657;" )
