	...
	*/
	...
	Else
		...
		While !Eof()
			...
			NgSomaLi(58)
			@Li,000 Psay (cAliasQry)->TRX_MULTA Picture "@R! 999/99/99"
			@Li,010 Psay (cAliasQry)->TRX_NUMAIT
			@Li,025 Psay (cAliasQry)->TRX_CCUSTO
			@Li,046 Psay (cAliasQry)->TRX_CODBEM
			@Li,063 Psay STOD((cAliasQry)->TRX_DTINFR) Picture "99/99/9999"
			@Li,074 Psay (cAliasQry)->TRX_NUMAR
			@Li,096 Psay (cAliasQry)->TRX_NF
			@Li,107 Psay NGRETSX3BOX("TRX_RECAUT",(cAliasQry)->TRX_RECAUT)
			If !Empty((cAliasQry)->TRX_RESTIT)
				@Li,116 Psay NGRETSX3BOX("TRX_RESTIT",(cAliasQry)->TRX_RESTIT)
			EndIf
			@Li,122 Psay STOD((cAliasQry)->TRX_DTVECI) Picture "99/99/9999"
			@Li,134 Psay PADL(Transform((cAliasQry)->TRX_DESCON,"@E 999,999,999.99"),14)
			@Li,150 Psay PADL(Transform((cAliasQry)->TRX_VALOR - (cAliasQry)->TRX_DESCON,"@E 999,999,999.99"),14)
			If lIntFin
				@Li,166 Psay (cAliasQry)->TRX_NUMSE2
			EndIf
			NgSomaLi(58)
			If lOfuscar
