...
@param nRecNo 		numero do registro base para integracao
@param cTbl   		codigo da tabela, utilizado quando a mensagem pode ser
              		gerada a partir de tabelas diferentes
@param lMem   		indica se busca conteudo da memoria (desabilitado)
@param nOpc   		indica operacao de inclusao/alteracao/exclusao
@param aIt    		itens do pedido
@param aParc  		indica utilizacao de parcelamento (desabilitado) obrigatorio quando SE2*
@param cRelated	indica a tabela do MNT relacionada com a multa (TRX/TS2), utilizado apenas quando cTBL eh "SE2"
...
/*/
//---------------------------------------------------------------------
Function NGMUOrder(nRecNo,cTbl,lMem,nOpc,aIt,aParc,cRelated)
