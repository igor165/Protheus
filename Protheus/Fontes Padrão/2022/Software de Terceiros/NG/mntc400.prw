...
Static Function QueryTT1(_nPar)
	...
	Endif
	cQuery += " AND STJ.TJ_DTMPINI >= '"+DTOS(dTpAnaliDe)+"'"
	cQuery += " AND STJ.TJ_DTMPINI <= '"+DTOS(dTpAnaliAte)+"'"
	If _nPar == 2
...
Static Function QueryTT2(_nPar)
	...
	Endif
	cQuery += " AND STS.TS_DTMPINI >= '"+DTOS(dTpAnaliDe)+"'"
	cQuery += " AND STS.TS_DTMPINI <= '"+DTOS(dTpAnaliAte)+"'"
	If _nPar == 2
