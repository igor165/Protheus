...
Else
	...
	Else
		...
		oPrint01:line(455+nAti,1470,515+nAti,1470) //linha vert
		oPrint01:line(395,1900,515+nAti,1900) //linha vert
		oPrint01:Say(400,520,STR0060,oFont11) //"Nº INT."
		oPrint01:Say(465,520,Alltrim(TLA->TLA_CODEXT),oFont11n)
		...
		oPrint01:Say(405,350,Substr(TLA->TLA_TIPO,1,20),oFont09n)
		...
		oPrint01:Say(465+nAti,1250,fDtProxEve( 1 ),oFont09n)
		oPrint01:Say(465+nAti,1480,STR0066,oFont10) //"TESTE"
		oPrint01:Say(465+nAti,1680,fDtProxEve( 2 ),oFont09n)
		...
		oPrint01:Say(525+nAti,1380,TLA->TLA_NUMFAB,oFont09n)
		oPrint01:line(515+nAti,1750,575+nAti,1750) //linha vert
		oPrint01:line(515+nAti,2025,575+nAti,2025) //linha vert
		...
		oPrint01:Say(525+nAti,1760,"PV",oFont10)
		oPrint01:Say(525+nAti,1873,Substr(cVal0,1,10),oFont09n)
		cVal1 := Alltrim(TransForm(nVal2,"@E 999,999")) + " " + TLA->TLA_PESOUN
		oPrint01:Say(525+nAti,2035,"PC",oFont10)
		oPrint01:Say(525+nAti,2148,Substr(cVal1,1,10),oFont09n)
