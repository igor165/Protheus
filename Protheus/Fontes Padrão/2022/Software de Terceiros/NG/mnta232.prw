...
Static Function VldOpenRod(lOpened,cOrdem,cPlano)
	...
	If GetScreenRes()[2] < 768 .Or. GetScreenRes()[1] < 1024
		ShowHelpDlg(STR0009,{STR0068},1,{STR0069},2) //"Atenção"##"A resolução do seu monitor não está compatível."###"Ajustar para no mínimo 1024x768 Pixels."
		Return .F.
	EndIf
