...
begin
    ...
    Select @iN3_PERDEPR = 0, @nN3_PRODMES = 0, @nN3_PRODANO = 0, @nN3_VMXDEPR = 0, @nN3_VLSALV1 = 0, @nN3_VRDACM1 = 0, @cN3_TPSALDO = ' '
    ##FIELDP17( 'SN1.N1_CALCPIS' )
    , @cN1_CALCPIS = ' '
    ##ENDFIELDP17
    ...
    select N3_CBASE,   N3_ITEM,    N3_TIPO,    N3_SEQ,     N3_TPDEPR,  N3_DEPREC,  N3_CCORREC, N3_CCCORR,  N3_SUBCCOR,
            N3_BAIXA,   N3_VRDACM1, N3_VORIG1,  N3_VORIG2,  N3_VORIG3,  N3_VORIG4,  N3_VORIG5,  N3_TXDEPR1, N3_TXDEPR2,
    ...
    Where N3_FILIAL      between @cFilial_SN3 and @IN_FILIALATE
        ...
        and (N3_BAIXA < '1' OR (N3_BAIXA >= '1' AND N3_NOVO = '1'))
    ...
    Fetch CUR_ATF050 into
            ...
            @cN3_BAIXA,   @nN3_VRDACM1, @nN3_VORIG1,  @nN3_VORIG2,  @nN3_VORIG3,  @nN3_VORIG4,  @nN3_VORIG5,  @nN3_TXDEPR1, @nN3_TXDEPR2,
    ...
    While (@@Fetch_status = 0 ) begin
        ...
        Select @nValor3 = 0, @nValor4   = 0,    @nValor5 = 0,   @nValorX = 0,   @iRecnoTp07 = null, @nAMPLIA1 = 0,  @nAMPLIA2 = 0,  @nAMPLIA3 = 0,   @nAMPLIA4 = 0, @nAMPLIA5 = 0
            ...
            If @iRecnoAux is null begin
                If @cN3_DTBAIXA != ' ' and   (( Substring( @cN3_DTBAIXA, 5, 2 ) < Substring( @IN_DATADEP, 5, 2 ) ) and 
                    ...
                    Where R_E_C_N_O_ =   @iRecnoSN3
                        ...
                        ---------------------------------------------------------------------------------*/
                        Select @cN1_GRUPO = N1_GRUPO, @iRecnoSN1 = R_E_C_N_O_
