	...
	Do Case
		...
		If ValType(oModelDet) == 'O' .and. oModelDet:Length(.t.) > 0
			...
			For nX := 1 to oModelDet:Length()
				...
				//Se AlteraÁ„o/Inclus„o e a linha estiver apagado, n„o manda Family -- Se for Exclus„o manda a linha para controle
					...
					If (nCont := oXml:xPathChildCount(cBusiCont + '/ListOfPaymentForm') ) > 0
						...
						For nX := 1 To nCont
							If lRet
								...
								If cEvent <> MODEL_OPERATION_DELETE
									// caso seja inserÁ„o e n„o tem DE/PARA da G8R
									// recuperar o cÛdigo da FORMA DE PAGTO atravÈs do DE/PARA da G3N
