...
@table BSC018A
--------------------------------------------------------------------------------------*/
#define TAG_ENTITY "TARDOC"
#define TAG_GROUP  "TARDOCS"
#define TEXT_ENTITY STR0001/*//"Documento"*/
#define TEXT_GROUP  STR0002/*//"Documentos"*/

class TBSC018A from TBITable
...
method New() class TBSC018A
	::NewBSC018A()
return
method NewBSC018A() class TBSC018A
	local oField
	...
	// Indexes
	::addIndex(TBIIndex():New("BSC018AI01",	{"ID"},		.t.))
	::addIndex(TBIIndex():New("BSC018AI02",	{"NOME", "CONTEXTID"},	.t.))
	::addIndex(TBIIndex():New("BSC018AI03",	{"PARENTID", "ID"},	.t.))
return

// Arvore
method oArvore(nParentID) class TBSC018A
...
method oToXMLList(nParentID) class TBSC018A
...
// Carregar
method oToXMLNode(nParentID) class TBSC018A
...
method nInsFromXML(oXML, cPath) class TBSC018A
...
method nUpdFromXML(oXML, cPath) class TBSC018A
...
method nDelFromXML(nID) class TBSC018A
...
method nDuplicate(nParentID, nNewParentID, nNewContextID) class TBSC018A
