...
For nI:=1 To Len(aCalend)	
    If aCalend[nI][CALEND_POS_TIPO_MARC] == "1E"
        ...
        aRows := TrataAgenda(aClone(aCalend[nI]), aAgenda, aCalendAux , ASCAN(aCalend, {|a| a[CALEND_POS_TIPO_MARC] == "1E"}, nI+1) == 0 )
...
/*/
Static Function TrataAgenda(aRow, aAgenda, aCalendAux, lUltimoDia)
Local nPos      := 0	
Local aRows     := {}
Local nI        := 1
Local nMarc     := 1
...
BeginSQL Alias cAlsTrb
    SELECT 
        ...
        ABB.ABB_DTINI, ABB.ABB_HRINI, ABB.ABB_DTFIM, ABB.ABB_HRFIM, ABB.ABB_MANUT, ABB.ABB_FILIAL, ABB.ABB_CODIGO, ABB.ABB_TIPOMV,
