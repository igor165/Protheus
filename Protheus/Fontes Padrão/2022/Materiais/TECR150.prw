...
DEFINE REPORT oReport NAME "TECR150" TITLE STR0001 PARAMETER "TECR150" ACTION {|oReport| Tcr150PrtRpt(oReport, cPerg)} DESCRIPTION  STR0001 //"Entregas CIF" ## "Entregas CIF/FOB"
	...
	DEFINE SECTION oSection1 OF oReport TITLE STR0003 TABLES "ABS" //"Cidade"
		...
		DEFINE CELL NAME "X5_DESCRI"	OF oSection1 TITLE STR0007 ALIAS "SX5"
...
BEGIN REPORT QUERY oSection1
	BEGIN REPORT QUERY oSection2
		...
		BeginSql alias cAlias
			...
			SELECT ABS.ABS_MUNIC,  SX5.X5_DESCRI,  TFJ.TFJ_TPFRET, ABS.ABS_DESCRI, ABS.ABS_END, SB1.B1_DESC,
...
If !oReport:Cancel() .And. !(cAlias)->(EOF())
	...
	While !oReport:Cancel() .And. !(cAlias)->(Eof())
		oSection1:Init()
		oSection1:PrintLine()
		cChave	:= (cAlias)->ABS_MUNIC + (cAlias)->X5_DESCRI
		While !oReport:Cancel() .And. !(cAlias)->(Eof()) .AND. cChave	== (cAlias)->ABS_MUNIC + (cAlias)->X5_DESCRI
			oSection2:Init()
			oSection2:PrintLine()
			(cAlias)->(dbSkip())
		EndDo
