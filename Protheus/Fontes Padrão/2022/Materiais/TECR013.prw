...
Static Function RepInit()
	...
	TRCell():New(oSection2,"ABX_VLMEDI"		,"ABX"	,"Vlr Antecipado")
	TRCell():New(oSection2,"ABX_VLAPUR"		,"ABX"	,"Vlr Apur Comp Ant")
...
Static Function PrintReport(oReport)
	...
	BeginSql alias "QRY_COM"			 		 				
		SELECT  ABX_MESANO, ABX_CONTRT, ABX_CODPLA, ABX_CONREV,ABX_VLMEDI,ABX_VLAPUR, ABX_VLMEDI + ABX_VLAPUR ABX_VLTOT,
