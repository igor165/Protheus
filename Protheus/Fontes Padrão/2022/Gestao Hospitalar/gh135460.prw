...
±±³Fun‡ao    ³GH135460  ³ Autor ³ MICROSIGA             ³ Data ³ 23/11/07 ³±±
...
Processa({|| ProcATU()},"Processando [GH135460]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
   ...
   lExist     := HS_ExisDic({{"T", "GND"}, {"T", "GNE"} },.F.)
			ProcRegua(8)
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH135460] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
