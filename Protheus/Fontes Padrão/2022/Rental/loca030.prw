...
CQUERY +=   " AND  ZLW.FPS_VIAGEM = '"+ FQ5->FQ5_VIAGEM +"'"
...
//	NLIN    := 400
 ...
 //	OOBJPRINT:STARTPAGE()
	...
	CQRY +=        " LEFT JOIN "+ RETSQLNAME("FPO")+ " AS ZLG ON ZLG.D_E_L_E_T_ = '' AND FPO_VIAGEM = FPS_VIAORI AND FPO_CARRET = '"+FQ5->FQ5_PACLIS+"' " 
	CQRY += " WHERE  ZLW.D_E_L_E_T_ = '' "
 //	CQRY +=   " AND  ZLW.FPS_PROJET = '" + X_PROJETO + "' "
 //	CQRY +=   " AND  ZLW.FPS_OBRA   = '" + X_OBRA    + "' "
	CQRY +=   " AND  ZLW.FPS_VIAGEM = '" + X_VIAGEM  + "' "
 ...
 //	TCSETFIELD("TRAB","FPL_DTFIM",   "D",8,0)
	...
	CQRY += " AND FPO_CARRET     = '" + FQ5->FQ5_PACLIS + "' "
	CQRY += " WHERE ZUC.D_E_L_E_T_ = '' "
 //	CQRY += " AND ZLW.FPS_PROJET = '" + X_PROJETO + "' "
 //	CQRY += " AND ZLW.FPS_OBRA   = '" + X_OBRA    + "' "
	CQRY += " AND ZUC.FQ7_VIAGEM = '" + X_VIAGEM  + "' "
 //	CQRY += " AND FPO_STATUS NOT IN ('E','S','A') "
...
// SEGUNDO BOX - CLIENTE                                                                                    
    ...
    OOBJPRINT:SAY( 0260 + NLIN , 0040 ,  STR0012 + TRANSFORM(CGC,"@R 99.999.999/9999-99")										, OFONT10   , 100 ) //"C.N.P.J:"
